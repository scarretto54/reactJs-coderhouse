...
const Footer = () => {
  ...
  return (
    ...
    <span className="text-muted sm-2"><strong>QuieroVino© 2021 Company.</strong></span>
                    ...
                    <a href="https://wa.me/5491135865454" Style="color:#ffffff;" target=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
